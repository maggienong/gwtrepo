...
public class NativeVerticalScrollbar_NativeVerticalScrollbarUiBinderImpl implements UiBinder<com.google.gwt.dom.client.Element, com.google.gwt.user.client.ui.NativeVerticalScrollbar>, com.google.gwt.user.client.ui.NativeVerticalScrollbar.NativeVerticalScrollbarUiBinder {
  ...
  class Widgets {
    ...
    SafeHtml template_html1() {
      return template.html1("" + get_style().viewport() + "", "" + get_style().scrollable() + "", get_domId0(), get_domId1());
    }
     ...
     */
    private com.google.gwt.user.client.ui.NativeVerticalScrollbar_NativeVerticalScrollbarUiBinderImpl_GenCss_style style;
    private com.google.gwt.user.client.ui.NativeVerticalScrollbar_NativeVerticalScrollbarUiBinderImpl_GenCss_style get_style() {
      return style;
    }
    private com.google.gwt.user.client.ui.NativeVerticalScrollbar_NativeVerticalScrollbarUiBinderImpl_GenCss_style build_style() {
      // Creation section.
